...
hifuScan.Transmit.Waveform.Duration         = 5;
hifuScan.Transmit.Waveform.Amplitude        = 0.2;
...
worker = hifuOp.newWorker('RFB','ULab.Worker.ForceMeasure');
worker.Scale = scale;
worker.MeasureTime = hifuScan.Transmit.Waveform.Duration/2;
