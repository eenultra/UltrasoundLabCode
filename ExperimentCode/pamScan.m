...
% with the 10MHz transducer and focused laser spot. No laser control at this point.
...
aqTime     = 14;                        % approx total aquisition time in us
...
yRes = 0.5;  % y resolution in mm 
xRng = 10;   % x scan range in mm
xRes = 0.5;  % x resolution in mm
...
save ([fname '_map.mat'],'xPoints','yPoints','mapDat','zSt','t','fs','cardInfo','expDetails');
