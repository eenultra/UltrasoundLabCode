 ...
 */
FARPROC WINAPI LUARPDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = LUARPDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = LUARPDelayLoadWin32FailureHook;
#endif
