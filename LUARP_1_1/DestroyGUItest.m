function varargout = DestroyGUItest(varargin)
% DESTROYGUITEST MATLAB code for DestroyGUItest.fig
%      DESTROYGUITEST, by itself, creates a new DESTROYGUITEST or raises the existing
%      singleton*.
%
%      H = DESTROYGUITEST returns the handle to a new DESTROYGUITEST or the handle to
%      the existing singleton*.
%
%      DESTROYGUITEST('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DESTROYGUITEST.M with the given input arguments.
%
%      DESTROYGUITEST('Property','Value',...) creates a new DESTROYGUITEST or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before DestroyGUItest_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to DestroyGUItest_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help DestroyGUItest

% Last Modified by GUIDE v2.5 11-Sep-2018 16:48:11

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @DestroyGUItest_OpeningFcn, ...
                   'gui_OutputFcn',  @DestroyGUItest_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before DestroyGUItest is made visible.
function DestroyGUItest_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to DestroyGUItest (see VARARGIN)

% Choose default command line output for DestroyGUItest
...
% UIWAIT makes DestroyGUItest wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = DestroyGUItest_OutputFcn(hObject, eventdata, handles) 
