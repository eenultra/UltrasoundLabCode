...
% Last Modified by GUIDE v2.5 16-Oct-2012 15:03:24
...
set(handles.PWM_Amplitude_Box,'String','User');
set(handles.User_Filename,'String','PRE.mat');
...
if (strcmp(get(handles.PWM_Amplitude_Box,'String'),'User'));
    filename = (get(handles.User_Filename,'String'));
    eval('load(filename)')
...
function User_Filename_Callback(hObject, eventdata, handles)
% hObject    handle to User_Filename (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of User_Filename as text
%        str2double(get(hObject,'String')) returns contents of User_Filename as a double


% --- Executes during object creation, after setting all properties.
function User_Filename_CreateFcn(hObject, eventdata, handles)
% hObject    handle to User_Filename (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
